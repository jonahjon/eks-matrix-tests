...
echo "******************************************************"
echo "installing kubectl manifest for Prometheus"
echo "******************************************************"

kubectl apply -f images/prometheus/templates/prometheus.yaml --wait
...
kubectl apply -f images/prometheus/templates/tests/tests.yaml --wait
...
kubectl delete -f images/prometheus/templates/prometheus.yaml --wait
